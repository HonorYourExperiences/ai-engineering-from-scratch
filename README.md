...
Run the non-interactive checks used by automation:
...
Preview locally when you want the interactive studio; this command starts a long-running Vite dev server and should not be used by maintenance scripts:
...
See `brand/layout-rules.md` for safe area and ratio guidance. The canonical WonderCards Studio GitHub repository is [HonorYourExperiences/bydt-wondercards-studio](https://github.com/HonorYourExperiences/bydt-wondercards-studio). The local WonderCard Designer skill lives at `.agents/skills/wondercard-designer/SKILL.md`.
